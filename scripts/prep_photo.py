...
# light global lift -- keep midtones so thin facial hair stays visible
gray = cv2.convertScaleAbs(gray, alpha=1.04, beta=8)
# mild sharpen so mustache / smile edges survive later downsampling
sharp = cv2.GaussianBlur(gray, (0, 0), 1.2)
gray = cv2.addWeighted(gray, 1.45, sharp, -0.45, 0)
